...
<style>
    ...
    /* Botón de Cerrar (Tache) Flotante Interno */
    .close-button-cri {
        position: fixed;
        top: 25px;
        right: 90px; /* Desplazado para no chocar con el de Flutter */
        width: 45px;
        height: 45px;
        background: rgba(232, 181, 71, 0.15);
    ...
    .close-button-cri:hover {
        ...
        box-shadow: 0 8px 25px rgba(232, 181, 71, 0.4);
    }
</style>

<div class="close-button-cri" onclick="window.parent.postMessage('close_cri', '*')" title="Cerrar Vista">×</div>
